                ...
                <div className="loginRight">
                    <form className="loginBox" onSubmit={handleClick}>
                        ...
                        <div className="google">
                            ...
                            <span className="googleDesc" onClick={google}>Google ile kayıt ol</span>    
                        </div>
                        <Link className="link" to="/login"> <button className="loginRegisterButton"> Hesabına giriş yap  </button></Link>
                    </form>
                </div>
            </div>
        </div>
